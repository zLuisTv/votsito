...
export default function PuzzleCarousel({
  ...
  return (
    <div
      className={`w-full md:w-[450px] overflow-x-auto flex space-x-1 p-[15px] bg-gray-100 bg-opacity-70 shadow rounded-md mb-4 scrollbar-hide`}
    >
      {pieces.map(piece => {
        ...
        if (isMobile) {
          ...
          return (
            <div
              ...
              className={`cursor-pointer flex-shrink-0 border-4 transition-all duration-300 ${
                isSelected
          ...
          return (
            <div
              ...
              className="cursor-grab flex-shrink-0 border border-gray-400 transition-all duration-300"
              style={{ width: 64, height: 64 }}
            >
              <Image
                src={`/puzzle/puz${piece + 1}.jpg`}
